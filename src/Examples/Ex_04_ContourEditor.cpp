 ...
 * @param y
 */
void ContourEditor::mouse2pix(int &x, int &y)
{
    x -= m_screen_width/2;
    y -= m_screen_height/2;
}
...
void ContourEditor::keyEvent(unsigned char key, bool up, int x, int y, int modif)
{
...
void ContourEditor::saveContoursToFile()
{
